...
class GatewayServer:
	...
	def subscribeToGuildEvents(self, onlyLarge=False, wait=None, guildIDs=None, token=None):
		imports.GuildCombo(self).subscribeToGuildEvents(onlyLarge, wait, guildIDs=guildIDs, token=token)
